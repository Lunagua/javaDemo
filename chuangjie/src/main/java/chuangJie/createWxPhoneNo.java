...
public class createWxPhoneNo {
    ...
    public static String getMD5Data(String publicKey, String signKey, String officialMode) {
        return getMD5Data(publicKey, signKey, new createWxPhoneNo().amount, officialMode);
    }
