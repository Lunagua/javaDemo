...
public class createAliQRCode {
    ...
    public static String getMD5Data(String publicKey, String signKey, String officialMode) {
        return getMD5Data(publicKey, signKey, new createAliQRCode().amount, officialMode);
    }
